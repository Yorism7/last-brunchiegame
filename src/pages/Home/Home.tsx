...
const Home: React.FC = () => {
  ...
  const showQuestionList = () => {
    showCustomAlert("รายการคำถาม", [
      "หมวดที่ 1 : ความสัมพันธ์",
      "หมวดที่ 2 : การงานและการเรียน",
      "หมวดที่ 3 : ครอบครัว",
      "หมวดที่ 4 : คำถามทั่วไป",
      "หมวดที่ 5 : ความรัก",
      "หมวดที่ 6 : คำถามผู้ใหญ่",
    ]);
  };

  const showHowToPlay = () => {
    showCustomAlert("เล่น", [
      "1. เลือกหมวดคำถามที่สนใจ",
      "2. อ่านคำถามและคิดคำตอบ",
      "3. ตอบคำถามตามความรู้สึก",
      "4. กดปุ่มเพื่อดูคำถามถัดไป",
      "5. เล่นต่อเนื่องเพื่อปลดล็อกคำถามใหม่",
    ]);
  };
